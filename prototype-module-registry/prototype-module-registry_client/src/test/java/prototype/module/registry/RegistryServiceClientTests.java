...
/**
 * 
 * Funtional test for {@link RegistryServiceClient}
 * 
 * @author Marcin Grzejszczak
 * 
 */
@RunWith(SpringRunner.class)
@SpringBootTest(classes = RegistryServiceClient.class, webEnvironment = SpringBootTest.WebEnvironment.RANDOM_PORT)
@ActiveProfiles("test")
public class RegistryServiceClientTests {
